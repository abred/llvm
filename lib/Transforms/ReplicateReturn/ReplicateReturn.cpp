...
struct ReplicateReturn : public FunctionPass {
	...
	bool runOnFunction(Function &F) override {
		...
		for (auto ri : worklist) {
			...
			Builder.CreateCall5(printFh, stestv, a1, a3, t1, t3);
			...
			Builder.CreateCall2(printFh, strTrue, strFuncName);
			...
			Builder.CreateCall2(printFh, strFalse, strFuncName);

			Value* c2  = Builder.CreateICmpEQ(t2, t3);
			Builder.CreateCall5(printFh, stestv, a2, a3, t2, t3);
...
//					    BranchInst::Create(blockTrue2,blockFalse2,c2));
			...
			Builder.CreateCall5(printFh, stestv, a1, a2, t1, t2);
